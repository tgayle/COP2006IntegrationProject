...
public class TicTacToePlayer implements PlayerInterface {
   ...
   * @param representingLetter The character being used to represent the player, such as 'X'
   * @param isAi boolean value whether or not the player is supposed to be an AI.
   */
